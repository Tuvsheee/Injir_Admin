...
const Add = () => {
  ...
  const onSubmit = () => {
    ...
    axios
      .post("https://tanusoft.tanuweb.cloud/api/v1/project/", formData)
      .then((res) => {
        alert("success");
        router.push("/project");
      })
  ...
  return (
    <>
      <div className="w-full border-b-[#e5e5e5] border-b h-20 bg-white flex items-center justify-between px-10  top-0 z-0">
        <span className="text-[#162C43] text-lg"> Төсөл нэмэх</span>
        <div
            ...
            <div className="w-full">
              <div className="w-full p-4  flex items-center">
                <div className="flex flex-col gap-2  w-[50%] p-4">
                  <span className="text-xs text-[#162c43]">Төслийн нэр</span>
                  <input
                    type="text"
                    name="title"
                    value={form.title}
                ...
                <div className="flex flex-col gap-2  w-[50%] p-4">
                  <span className="text-xs text-[#162c43]">Төслийн тайлбар</span>
                  <input
                    type="text"
                    name="description"
